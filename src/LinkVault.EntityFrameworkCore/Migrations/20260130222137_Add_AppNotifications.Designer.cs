...
namespace LinkVault.Migrations
{
    ...
    [Migration("20260130222137_Add_AppNotifications")]
    partial class Add_AppNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinkVault.Collections.Collection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LinkVault.Links.Link", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LinkVault.Links.LinkTag", b =>
                {
                    ...
                    b.ToTable("AppLinkTags", (string)null);
                });

            modelBuilder.Entity("LinkVault.Notifications.AppNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LinkVault.Reminders.LinkReminder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IsTriggered", "RemindAt");

                    b.HasIndex("LinkId", "IsTriggered");

                    b.ToTable("AppLinkReminders", (string)null);
                });

            modelBuilder.Entity("LinkVault.Settings.UserEmailPreferences", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppUserEmailPreferences", (string)null);
                });

            modelBuilder.Entity("LinkVault.Settings.UserReminderSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppUserReminderSettings", (string)null);
                });

            modelBuilder.Entity("LinkVault.Tags.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LinkVault.Collections.Collection", b =>
                {
                    b.HasOne("LinkVault.Collections.Collection", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("LinkVault.Links.Link", b =>
                {
                    b.HasOne("LinkVault.Collections.Collection", "Collection")
                        .WithMany("Links")
            ...
            modelBuilder.Entity("LinkVault.Links.LinkTag", b =>
                {
                    b.HasOne("LinkVault.Links.Link", "Link")
                        .WithMany("LinkTags")
                        .HasForeignKey("LinkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LinkVault.Tags.Tag", "Tag")
                        .WithMany("LinkTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
